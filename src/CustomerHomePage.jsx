...
export default function CustomerHomePage() { 
    ...
    useEffect(() => { 
        ...
        const fetchCartCount = async () => { 
            ...
            try { const response = await fetch(`http://localhost:9090/api/cart/items/count?username=${username}`, { 
            credentials: 'include', // Include authToken as a cookie 
            });
        ...
        const handleAddToCart = async (productId) => { 
            ...
            try { 
                ...
                credentials: 'include', method: 'POST', body: JSON.stringify({ username, productId }), // Include username and productId in the request 
                headers: { 'Content-Type': 'application/json' }, // Include authToken as a cookie 
                });
