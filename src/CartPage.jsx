...
const CartPage = () => { 
    ...
    useEffect(() => { 
        const fetchCartItems = async () => { 
            try { 
                ...
                setCartItems( data?.cart?.products.map((item) => ({ 
                    ...item, 
    ...
    const handleCheckout = async () => { 
        try { 
            ...
            const options = { 
                key: "rzp_test_IfmwxndxctON9o", // Replace with your Razorpay Key ID 
    ...
    if (cartItems.length === 0) { 
        return (
            <div>Your Cart is Empty. Add some items to get started!</div>
        ); 
    }
